...
function QuizGraph() {
  ...
  function graph(selection, prereqs, postreqs, theQuizID) {
  ...
  graph.setupTree = function() {
    ...
    // var thisNode = svg.selectAll("#" + quizID).classed("active", true);
